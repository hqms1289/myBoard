...
//import com.myproject.myBoard.dto.BoardDTO;
 ...
 * 
 * public int getDataCount(String searchKey, String searchValue) throws
 * Exception;
 * 
 * public List<BoardDTO> getLists(int start,int end, String searchKey, String
